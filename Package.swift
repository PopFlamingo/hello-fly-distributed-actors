...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/PopFlamingo/swift-distributed-actors.git", branch: "log-lock"),
        .package(url: "https://github.com/PopFlamingo/swift-fly-app-discovery.git", branch: "use-log-lock")
    ],
    targets: [
